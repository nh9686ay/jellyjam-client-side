    ...
    <div className={"side-nav " + props.toggleMenu}>
        <div className="home-link-btn" >
            <Link to={'/'} className="link">
                <h1 className="nav-text2">Home</h1>
            </Link>
        </div>
        <div className="search-link-btn">
            <Link to={'/search'} className="link" >
                <h1 className="nav-text2"><SearchIcon height="2.2rem" width="2.2rem" /> Search</h1>
            </Link>
        </div>
        <div className="library-link-btn" >
            <Link to={'/library'} className="link" >
                <h1 className="nav-text2">Library</h1>
            </Link>
        </div>
        <div className="create-playlist-link-btn" >
            <Link to={'/create/playlist'} className="link" >
                <h1 className="nav-text2">Create Playlist</h1>
            </Link>
        </div>
        <div className="liked-songs-link-btn" >
            <Link to={'/#'} className="link" >
                <h1 className="nav-text2">Liked Songs</h1>
            </Link>
        </div>
    </div>
  )
